/// ENLCEDRICSimPrimaryGeneratorAction.cc
...
ENLCEDRICSimPrimaryGeneratorAction::ENLCEDRICSimPrimaryGeneratorAction(){
  //G4int n_particle = 1;
...
void ENLCEDRICSimPrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent){
